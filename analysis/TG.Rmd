...
corporate_profits_btaxes_1948_1987 <- leer_tablas_bea("../data/Table 6.17B. Corporate Profits Before Tax by Industry_1948-1987.csv") %>% 
  select(-"1948") 
corporate_profits_btaxes_1987_2000 <- leer_tablas_bea("../data/Table 6.17C. Corporate Profits Before Tax by Industry_1987-2000.csv") %>% 
  select(-"1987")
corporate_profits_btaxes_2000_2018 <- leer_tablas_bea("../data/Table 6.17D. Corporate Profits Before Tax by Industry_2000-2018.csv") %>%
  select(-"2000") 
