...
```{r message=FALSE, warning=FALSE}
base_manuf_us <- read_csv( "fuentes/manufacturing_production.csv")
```
...
```{r message=FALSE, warning=FALSE}
base_employ_us <- read_csv("fuentes/employ.csv")
```
...
```{r}
base_manuf_arg04 <- read_csv("fuentes/va_p_ctes_arg.csv")
...
```{r}
empleo_nacional_serie_trimestral <- read_excel("fuentes/empleo_arg.xlsx", 
