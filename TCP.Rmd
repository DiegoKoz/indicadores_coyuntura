...
```{r message=FALSE, warning=FALSE}
base_manuf_us <- read_csv("../../../Archivos/Datos/TCP/Fuentes/IPGMFSQ.csv")
```
...
```{r message=FALSE, warning=FALSE}
base_employ_us <- read_csv("../../../Archivos/Datos/TCP/Fuentes/file.csv")
```
...
```{r}
base_ipc_us <- read_csv("../../../Archivos/Datos/TCP/Fuentes/cpi.csv")
```
